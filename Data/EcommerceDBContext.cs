...
namespace Ecommerce_App.Data
{
    public class EcommerceDBContext : IdentityDbContext<AuthUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(new Product { Id = 1, Name = "Sun Blade", Description = "This appears to be a long sword hilt, but it emenates a radiant energy", Price = 100.00m, ImgUrl = "https://media-waterdeep.cursecdn.com/avatars/thumbnails/7/436/1000/1000/636284772783859015.jpeg" });
